...
public:
  ...
  virtual ~DcmQueryRetrieveConfig();
   ...
   *     0 - error
   */
  virtual int init(const char *ConfigurationFile);
   ...
   *     0 - not found
   */
  virtual int peerForAETitle(const char *AETitle, const char **HostName, int *PortNumber) const;
   ...
   *     0 - else
   */
  virtual int checkForSameVendor(const char *AETitle1, const char *AETitle2) const;
   ...
   *  Return : Storage Area
   */
  virtual const char *getStorageArea(const char *AETitle) const;
   ...
   */
  virtual int getMaxStudies(const char *AETitle) const;
   ...
   */
  virtual long getMaxBytesPerStudy(const char *AETitle) const;
   ...
   */
  virtual int getMaxAssociations() const;
   ...
   */
  virtual int getNetworkTCPPort() const;
   ...
   *  Return : Max PDU Size
   */
  virtual OFCmdUnsignedInt getMaxPDUSize() const;
   ...
   *     0 -- no
   */
  virtual int peerInAETitle(const char *calledAETitle, const char *callingAETitle, const char *HostName) const;
   ...
   *  Return : Access mode
   */
  virtual const char *getAccess(const char *AETitle) const;
   ...
   */
  virtual OFBool writableStorageArea(const char *aeTitle) const;
  ...
  virtual int aeTitlesForPeer(const char *hostName, const char *** aeTitleList) const;
  ...
  virtual int ctnTitles(const char *** ctnTitleList) const;
   ...
   *     0 if no entries exist
   */
  virtual int HostNamesForVendor(const char *Vendor, const char ***HostNameArray) const;
   ...
   *      0 if no entries found.
   */
  virtual int aeTitlesForSymbolicName(const char *symbolicName, const char ***aeTitleList) const;
   ...
   */
  virtual const DcmQueryRetrieveCharacterSetOptions& getCharacterSetOptions() const;
   ...
   *  Return : Character Set Options
   */
  virtual DcmQueryRetrieveCharacterSetOptions& getCharacterSetOptions();
